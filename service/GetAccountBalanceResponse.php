...
class GetAccountBalanceResponse extends AbstractResponse
{
     ...
     */
    public function __construct($ResultCode, $Currency, $Vat, $UnInvoicedOrders, $UnInvoicedOpenOrders, $UnInvoicedCompletedOrders, $UnInvoicedCompletedOrdersLast24h, $AccountBalance, $CurrentBalance)
    {
     ...
     * @return \ascio\v3\GetAccountBalanceResponse
     */
    public function setLastReminderSent(\DateTime $LastReminderSent)
    {
     ...
     * @return \ascio\v3\GetAccountBalanceResponse
     */
    public function setLastBlockedAccountMessageSent(\DateTime $LastBlockedAccountMessageSent)
    {
