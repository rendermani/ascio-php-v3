...
class SslCertificateInfo
{
    ...
    /**
     * @var string $SslProductName
     */
    protected $SslProductName = null;
     ...
     * @return string
     */
    public function getSslProductName()
    {
      return $this->SslProductName;
    }

    /**
     * @param string $SslProductName
     * @return \ascio\v3\SslCertificateInfo
     */
    public function setSslProductName($SslProductName)
    {
      $this->SslProductName = $SslProductName;
      return $this;
    }
