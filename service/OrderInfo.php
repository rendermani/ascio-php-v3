...
class OrderInfo
{
    ...
    /**
     * @var ArrayOfOrderHistory $OrderStatusHistory
     */
    protected $OrderStatusHistory = null;
     ...
     */
    public function __construct($Status, \DateTime $Created, $CreatedBy)
    {
      $this->Status = $Status;
    ...
    /**
     * @param ArrayOfOrderHistory $OrderStatusHistory
     * @return \ascio\v3\OrderInfo
     */
